...
<div class="app-shell">
  ...
  <?php endif; ?>
        ...
        <div class="banner-info">
          ...
          <span style="display:inline-block; margin-top:8px; padding:4px 14px; background:rgba(255,255,255,0.2); border-radius:20px; font-size:13px; font-weight:700; letter-spacing:0.5px;">
            🏷️ Section: <?= htmlspecialchars($user['section']) ?>
          </span>
          <?php else: ?>
          <span style="display:inline-block; margin-top:8px; padding:4px 14px; background:rgba(255,200,0,0.25); border-radius:20px; font-size:13px; font-weight:700; color:#fde68a;">
            ⚠️ No section assigned yet
          </span>
          <?php endif; ?>
        </div>
      </div>
